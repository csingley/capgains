...
class TradesWithCancelTestCase(TradeXmlSnippetMixin, unittest.TestCase):
    ...
    def persisted_txs(self):
        ...
        return [
            Transaction(datetime=datetime(2011, 5, 9),
                        type='trade',
...
class TradesIgnoreTestCase(TradeXmlSnippetMixin, unittest.TestCase):
    ...
    def persisted_txs(self):
        ...
        return [
            Transaction(datetime=datetime(2015, 9, 10, 15, 51, 34),
                        type='trade',
                        ...
                        units=Decimal('-1000')),
            Transaction(datetime=datetime(2015, 9, 10, 15, 52, 20),
                        type='trade',
                        memo='SATURNS SEARS ROEBUCK ACCEPTANCE CO',
...
class TradesWithSortFieldTestCase(TradeXmlSnippetMixin, unittest.TestCase):
    ...
    def persisted_txs(self):
        return [
            Transaction(datetime=datetime(2010, 10, 29, 14, 38, 9),
                        type='trade',
                        memo='PILGRIMS PRIDE CORP-NEW',
                        currency='USD', cash=Decimal('1223'),
                        fiaccount=self.account, security=self.securities[0], units=Decimal('-200'),
                        sort='MINGAIN'),
        ]
